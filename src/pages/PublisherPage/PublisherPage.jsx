...
import { fetchPublisherData } from "../../redux/publisherRedux/publisherThunks";
import { setCurrentPage } from "../../redux/publisherRedux/publisherSlice";
...
export default function PublisherPage() {
  ...
  const { publisher, games, loading, currentPage, gamesPerPage, totalGames } = useSelector(state => state.publisher);
  ...
  useEffect(() => {
    dispatch(fetchPublisherData(id)); 
